          ...
          <AnimatePresence>
            ...
            {submissionStatus === "error" && (
              <motion.div
                ...
                exit={{ opacity: 0, height: 0 }}
                transition={{ duration: 0.3 }}
                className="flex items-center gap-2 p-3 bg-red-500/10 text-red-400 rounded-lg border border-red-400/50"
              >
                <AlertCircle className="w-5 h-5 text-red-400" />
                <span className="text-sm text-red-400">Transmission failed. Please try again.</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
