...
const HomeSection: React.FC<HomeSectionProps> = ({
  ...
  const isTypingDone = terminalText === fullText;
    ...
    <div className="space-y-12">
      ...
      >
        ...
        <div className="p-8 space-y-4">
          ...
          {/* Always render — animate opacity instead of conditional mount to avoid CLS */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <h2 className="text-lg text-gray-400 font-mono flex flex-wrap items-center gap-2">
